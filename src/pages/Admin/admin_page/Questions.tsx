...
const Questions: React.FC = () => {
  const questions = [
    {
      id: 1,
      text: "Tailwind v4 dùng cơ chế gì để xử lý CSS?",
    ...
    {
      id: 2,
      text: "Component nào trong React Router dùng để render route con?",
    ...
    {
      id: 3,
      text: "TypeScript có chế độ Strict Mode không?",
    ...
    {
      id: 4,
      text: "Lệnh nào dùng để khởi tạo một dự án Node.js?",
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {questions.map((q) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-${q.color}-100 text-${q.color}-600 dark:bg-${q.color}-900/30 dark:text-${q.color}-400`}
                    >
                      {q.topic}
                    </span>
                  </td>
